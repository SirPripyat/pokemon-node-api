...
import { GetAllPokemonsFromType } from "./service/get-all-pokemons-from-type.service";
...
class PokemonController {
  ...
  public async getAllPokemonsFromType(req: Request, res: Response) {
    try {
      const { name, type } = req.params;

      const pokemons =
        await new GetAllPokemonsFromType().getAllPokemonsFromType(
          name as string,
